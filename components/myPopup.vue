			...
			<view v-show="show" class="detail-show-inner">
				<view class="inner-display">
					...
					<view class="inner-text">
						<image v-if="detail.garbageType==1" class="show-img" src="http://azuresky.top:9010/images/static/classify/style-gan.jpg"></image>
						<image v-else-if="detail.garbageType==2" class="show-img-shi" src="http://azuresky.top:9010/images/static/classify/style-shi.jpg"></image>
						<image v-else-if="detail.garbageType==3" class="show-img-huishou" src="http://azuresky.top:9010/images/static/classify/style-huishou.jpg"></image>
						<image v-else-if="detail.garbageType==4" class="show-img" src="http://azuresky.top:9010/images/static/classify/style-youhai.jpg"></image>
						<view>
