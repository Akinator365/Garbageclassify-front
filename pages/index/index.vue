			...
			<form @submit="formSubmit" @reset="formReset" class="form-form">
				<view class="input-view">
					<view @click="takePhoto2" class="input-view-item input-view-camera">
						<image class="search-img" src="http://azuresky.top:9010/images/static/icos/camera.png"></image>
					</view>
					<view @click="readyRecord2" class="input-view-item input-view-speech">
						<image class="search-img" src="http://azuresky.top:9010/images/static/icos/record.png"></image>
					</view>
		...
		<view class="main-show-classify">
			<view class="main-classify">
				<view @click="switchTabToClassify(1)">
					<image class="main-img" src="http://azuresky.top:9010/images/static/icos/ico-1.jpg"></image>
				</view>
				<view @click="switchTabToClassify(2)">
					<image class="main-img" src="http://azuresky.top:9010/images/static/icos/ico-2.jpg"></image>
				</view>
			</view>
			<view class="main-classify">
				<view @click="switchTabToClassify(3)">
					<image class="main-img" src="http://azuresky.top:9010/images/static/icos/ico-3.jpg"></image>
				</view>
				<view @click="switchTabToClassify(4)">
					<image class="main-img" src="http://azuresky.top:9010/images/static/icos/ico-4.jpg"></image>
				</view>
			</view>
		</view>
		<!-- popup start -->
